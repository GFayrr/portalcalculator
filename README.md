# Portal Calculator 1.20.4

A Fabric mod for Minecraft 1.20.4 that adds a `/convert` command to calculate
...
3. Download the latest `portal-calculator-1.20.4-x.x.x.jar` from [Releases](../../releases)
...
| Fabric API | 0.91.6+1.20.4 |
| Java | ≥ 21 |

## Building from source

```bash
git clone -b 1.20.4 https://github.com/GFayrr/portalcalculator.git
cd portalcalculator
./gradlew build
```
