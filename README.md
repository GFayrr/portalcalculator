# Portal Calculator 1.20.6

A Fabric mod for Minecraft 1.20.6 that adds a `/convert` command to calculate
...
1. Install [Fabric Loader](https://fabricmc.net/use/installer/) for Minecraft 1.20.6
2. Download [Fabric API](https://modrinth.com/mod/fabric-api)
3. Download the latest `portal-calculator-1.20.6-x.x.x.jar` from [Releases](../../releases)
...
| Fabric API | 0.91.6+1.20.6 |
| Java | ≥ 21 |

## Building from source

```bash
git clone -b 1.20.6 https://github.com/GFayrr/portalcalculator.git
cd portalcalculator
./gradlew build
```
