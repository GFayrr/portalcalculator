# Portal Calculator 1.21.5

A Fabric mod for Minecraft 1.21.5 that adds a `/convert` command to calculate
...
3. Download the latest `portal-calculator-1.21.5-x.x.x.jar` from [Releases](../../releases)
...
```bash
git clone -b 1.21.5 https://github.com/GFayrr/portalcalculator.git
cd portalcalculator
./gradlew build
```
