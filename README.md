# Portal Calculator 1.21.9

A Fabric mod for Minecraft 1.21.9 that adds a `/convert` command to calculate
...
1. Install [Fabric Loader](https://fabricmc.net/use/installer/) for Minecraft 1.21.9
2. Download [Fabric API](https://modrinth.com/mod/fabric-api)
3. Download the latest `portal-calculator-1.21.9-x.x.x.jar` from [Releases](../../releases)
...
```bash
git clone -b 1.21.9 https://github.com/GFayrr/portalcalculator.git
cd portalcalculator
./gradlew build
```
