# Portal Calculator 1.21.1

A Fabric mod for Minecraft 1.21.1 that adds a `/convert` command to calculate
...
3. Download the latest `portal-calculator-1.21.1-x.x.x.jar` from [Releases](../../releases)
...
```bash
git clone -b 1.21.1 https://github.com/GFayrr/portalcalculator.git
cd portalcalculator
./gradlew build
```
